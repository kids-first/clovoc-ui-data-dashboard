...
grab_fhir <- function(resource_name, desc_cols, url,
                      cookie, format, tags = NULL) {
...
```{r query-sparc}
sci_url <- "https://scicrunch.org/api/1/sparc-scigraph/dynamic/prod/sparc/anatomyPhenotypes/UBERON:0004535"
