...
# Grap Group resources from FHIR API endpoint
...
# Grap Patient resources from FHIR API endpoint
...
# Grap Condition resources from FHIR API endpoint
...
# Grap Specimen resources from FHIR API endpoint
...
# Extract patient IDs
specimens$"Patient ID" <- unlist(lapply(specimens$"Patient ID", ParsePatientID))
...
# Grap Specimen resources from FHIR API endpoint
Specimens <- grab_fhir(resource_name = "DocumentReference",
                      desc_cols = resource_columns,
                      url = fhir_api_url,
                      cookie = cookies,
                      format = "compact")
